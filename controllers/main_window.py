from PySide2.QtWidgets import QWidget, QTableWidgetItem, QAbstractItemView,QMessageBox
...
from pyside2_msgboxes import msg_boxes
import os
...
class ListBookWindow(QWidget, ListBookForm):
    ...
    def remove_book(self):
        ...
        resp = msg_boxes.warning_msgbox('Seguro?', 'Estasd seguro de eliminar este Libro?')
